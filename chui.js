...
async function connectionUpdate(update) {
  ...
  if (connection === 'open') {
    ...
    const msg = `𝙈𝙎𝙀𝙇𝘼-𝘾𝙃𝙐𝙄-𝙑3 𝐃𝐞𝐯𝐢𝐜𝐞 𝐬𝐮𝐜𝐜𝐞𝐟𝐮𝐥𝐥𝐲 𝐜𝐨𝐧𝐧𝐞𝐜𝐭𝐞𝐝 𝐭𝐨 𝐲𝐨𝐮𝐫𝐞 𝐰𝐡𝐚𝐭𝐬𝐚𝐩𝐩. 𝐞𝐧𝐣𝐨𝐲 𝐮𝐬𝐢𝐧𝐠 𝐢𝐭`
...
const pluginFolder = global.__dirname(join(__dirname, './mselachui/index'))
