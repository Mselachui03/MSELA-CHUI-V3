...
if (!m.quoted.text.includes("乂  Y O U T U B E  -  P L A Y")) return conn.reply(m.chat, `🐯 Tag the message containing the YouTube Play result.`, m, rcanal).then(_ => m.react('✖️'))
